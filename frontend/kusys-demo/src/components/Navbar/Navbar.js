...
const Navbar = ({ isAdmin, handleLogout, student }) => {
    ...
    // Öğrenci listesini görüntülemek için yönlendirme işlevi
    const handleStudentsClick = () => {
        navigate('/home/students', { state: { isAdmin: true } });
    };

    // Kullanıcının derslerini görüntülemek için yönlendirme işlevi
        ...
        <nav className="navbar navbar-expand-lg navbar-light bg-light py-3 px-5">
            ...
            <div className="collapse navbar-collapse justify-content-end" id="navbarNav">
                <ul className="navbar-nav d-flex gap-4 fs-6 ">
                    {isAdmin ? (
                        // Admin kullanıcısı için navbar öğeleri
                        <>
                        ...
                        // Öğrenci kullanıcısı için navbar öğeleri
                        <>
